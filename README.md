...
|[Bandizip](https://en.bandisoft.com/bandizip/)|Standard Edition 7.29|freeware|Yes :heavy_check_mark:|MOTW bypass vulnerability (fixed) <a href="#*3">*3</a><br>Only for specific file extensions <a href="#*4">*4</a>|
|[Explzh](https://www.ponsoftware.com/en/)|8.81|proprietary for commercial use|Yes :heavy_check_mark:||
|[NanaZip](https://github.com/M2Team/NanaZip)|2.0.396.0|MIT|Yes :heavy_check_mark:|Disabled by default <a href="#*5">*5</a>|
|[PeaZip](https://peazip.github.io/)|8.9.0|GNU LGPL|Yes :heavy_check_mark:||
|[WinRAR](https://www.win-rar.com/)|6.11 (trial)|proprietary|Yes :heavy_check_mark:|Only for specific file extensions <a href="#*6">*6</a>|
...
|[Bandizip](https://en.bandisoft.com/bandizip/)|Standard Edition 7.29|<ul><li>MOTW of the archive file is propagated without modification</li><li>Only for specific file extensions <a href="#*4">*4</a></li></ul>|
|[Explzh](https://www.ponsoftware.com/en/)|8.81|<ul><li>MOTW is propagated only if ZoneId value of the MOTW is 3 (Internet)</li><li>Only ZoneId field of the archive file is inherited and all other fields are ignored</li></ul>|
|[NanaZip](https://github.com/M2Team/NanaZip)|2.0.396.0|<ul><li>MOTW of the archive file is propagated without modification</li><li>Only for specific file extensions if the "Propagate Zone Id stream:" option is set to "For Office files" <a href="#*5">*5</a></li></ul>|
|[PeaZip](https://peazip.github.io/)|8.9.0|<ul><li>MOTW of the archive file is propagated without modification</li></ul>|
|[WinRAR](https://www.win-rar.com/)|6.11 (trial)|<ul><li>MOTW is propagated only if ZoneId value of the MOTW is 3 (Internet)</li><li>Only ZoneId field of the archive file is inherited and all other fields are ignored</li><li>Only for specific file extensions <a href="#*6">*6</a></li></ul>|
